...
def extract_bbox(response):
    ...
    if start_tag in input_str:
       ...
       # print(start_idx,"这个")
        ...
        try:
            bbox_list = json.loads(content_str_corrected)
            print(content_str_corrected ,"提取成功")
        except json.JSONDecodeError as e:
            bbox_list = None
            print(content_str_corrected ,"提取失败")
    else:
        bbox_list = None
    return bbox_list
...
def main():
    ...
    if multiprocess:
        ...
        ### save path
        with open('./coco_evaluation/2b_sft_prediction_results_15_figure.json', 'w') as json_file:
